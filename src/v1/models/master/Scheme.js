const { _collectionName, _schemeName, _status, _season, _period, _centralNodalAgency } = require("@src/v1/utils/constants");
...
const SchemeSchema = new mongoose.Schema(
  {
    ...
    schemeName: { type: String, enum: Object.values(_schemeName), default: _schemeName.Open },
