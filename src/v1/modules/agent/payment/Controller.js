                            ...
                            if: {
                                $anyElementTrue: {
                                    $map: {
                                        ...
                                        in: {
                                            $or: [
                                                { $not: { $ifNull: ['$$batch.agent_approve_at', true] } },  // Check if the field is missing
    ...
    try {
      ...
      if (isExport == 1) {
        ...
        if (record.length > 0) {
          ...
          return res.status(400).send(new serviceResponse({ status: 400, data: [], message: "No payments found" }));
        }
      } else {
