...
const { getProcurementCenter, createProcurementCenter, ImportProcurementCenter, generateCenterCode, editProcurementCenter } = require("./Controller");
...
procurementCenterRoutes.put("/:id", validateErrors,  editProcurementCenter, [
    body("center_name", _middleware.require("center_name")).notEmpty().trim(),
    // body("center_code", _middleware.require("center_code")).notEmpty().trim(),
    body("line1", _middleware.require("line1")).notEmpty().trim(),
    body("line2").optional().trim(),
